...
If you want to evaluate STRait Razor on a different chemistry, please feel free to reach out to us, and please if you use it in a scientific manuscript without optimization and it doesn't work well, that reflects on you (the researcher) not us (the developers)
